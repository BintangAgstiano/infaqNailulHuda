    ...
    <div class="main-header-container container-fluid">
        ...
        <div class="header-content-left">
            ...
            <div class="header-element header-search ms-3 d-none d-xl-block">
                <!-- Start::header-link -->
                <input class="form-control" placeholder="Search for results..." type="text"> <a
        ...
        <div class="header-content-right">
            ...
            <div class="header-element country-selector">
                ...
                <ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    <li>
                        <a class="dropdown-item dropdown-hover d-flex align-items-center"
            ...
            <div class="header-element header-shortcuts-dropdown">
                ...
                <a aria-label="anchor" href="javascript:void(0);" class="header-link dropdown-toggle"
                    data-bs-toggle="dropdown" data-bs-auto-close="outside" id="notificationDropdown"
                    aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                        viewBox="0 0 24 24" class="header-link-icon">
                        <path
                ...
                <div class="main-header-dropdown header-shortcuts-dropdown dropdown-menu pb-0 dropdown-menu-end"
                    ...
                    <div class="px-2 py-2">
                        <div class="row mb-2">
                            <div class="col d-flex">
                                <a href="vector-maps.html" class="related-app">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="text-center source-logo"
                        ...
                        <div class="row">
                            ...
                            <div class="col d-flex"> <a href="form_inputs.html" class="related-app"> <svg
                                        xmlns="http://www.w3.org/2000/svg" class="text-center source-logo"
                                        enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                        <path
                                        ...
                                        <div class="simplebar-content" style="padding: 0px;">
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-center cart-dropdown-item">
                                                    <div>
                                                        <img src="noa-assets/assets/images/ecommerce/1.jpg"
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <div
                                                            ...
                                                            <div>
                                                                <span
                                                                    class="text-dark mb-1 fs-16 fw-semibold">$129</span>
                                                            </div>
                                                        </div>
                                                        <div class="text-muted fs-12">
                                                            ...
                                                            <p class="mb-0 fw-normal text-gray">Quantity: 01 <a
                                                                    aria-label="anchor"
                                                                    href="javascript:void(0);"
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-center cart-dropdown-item">
                                                    <div>
                                                        <img src="noa-assets/assets/images/ecommerce/2.jpg"
                                                            alt="img" class="avatar avatar-lg me-2">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div
                                                            ...
                                                            <div>
                                                                <span
                                                                    class="text-dark mb-1 fs-16 fw-semibold">$99</span>
                                                            </div>
                                                        </div>
                                                        <div class="text-muted fs-12">
                                                            <span class="fw-normal">Status:
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-center cart-dropdown-item">
                                                    <div>
                                                        <img src="noa-assets/assets/images/ecommerce/3.jpg"
                                                            alt="img" class="avatar avatar-lg me-2">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div
                                                            ...
                                                            <div>
                                                                <span
                                                                    class="text-dark mb-1 fs-16 fw-semibold">$299</span>
                                                            </div>
                                                        </div>
                                                        <div class="text-muted fs-12">
                                                            <span class="fw-normal">Status: <span
                                                                    class="text-primary">In Stock</span>
                                                            </span>
                                                            <p class="mb-0 fw-normal text-gray">Quantity: 01 <a
                                                                    aria-label="anchor"
                                                                    href="javascript:void(0);"
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-center cart-dropdown-item">
                                                    <div>
                                                        <img src="noa-assets/assets/images/ecommerce/4.jpg"
                                                            alt="img" class="avatar avatar-lg me-2">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div
                                                            ...
                                                            <div>
                                                                <span
                                                                    class="text-dark mb-1 fs-16 fw-semibold">$249</span>
                                                            </div>
                                                        </div>
                                                        <div class="text-muted fs-12"> <span
                                                                class="fw-normal">Status: <span
                                            ...
                                            <li class="dropdown-item p-3">
                                                <div class="d-flex align-items-center cart-dropdown-item">
                                                    <div>
                                                        <img src="noa-assets/assets/images/ecommerce/5.jpg"
                                                            alt="img" class="avatar avatar-lg me-2">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div
                                                            ...
                                                            <div>
                                                                <span
                                                                    class="text-dark mb-1 fs-16 fw-semibold">$1,279</span>
                                                            </div>
                                                        </div>
                                                        <div class="text-muted fs-12">
                                                            <span class="fw-normal">Status: <span
            ...
            <div class="header-element message-dropdown">
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end"
                                    ...
                                    <div class="simplebar-content-wrapper" tabindex="0" role="region"
                                        ...
                                        <div class="simplebar-content" style="padding: 0px;">
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-center cart-dropdown-item">
                                                    <div>
                                                        <img src="noa-assets/assets/images/users/1.jpg"
                                                            alt="img" class="avatar avatar-md me-3">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div
                                                            class="d-flex align-items-start justify-content-between mb-0">
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-start">
                                                    <div>
                                                        <img src="noa-assets/assets/images/users/15.jpg"
                                                            alt="img" class="avatar avatar-md me-3">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-start">
                                                    <div>
                                                        <img src="noa-assets/assets/images/users/12.jpg"
                                                            alt="img" class="avatar avatar-md me-3">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div
                                                        ...
                                                        <div class="text-muted">
                                                            <span class="fw-normal fs-12">Ready to submit
                                                                future
                                                                data....</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-start">
                                                    <div>
                                                        <img src="noa-assets/assets/images/users/4.jpg"
                                                            alt="img" class="avatar avatar-md me-3">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div
                    ...
                    <div class="dropdown-footer">
                        <a href="chat.html" class="dropdown-footer btn btn-primary my-0">View All
                            Messages</a>
                    </div>
                </div>
                <!-- End::main-header-dropdown -->
                                        ...
                                        <div class="simplebar-content" style="padding: 0px;">
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-start">
                                                    <div class="pe-2">
                                                        <span class="avatar avatar-md bg-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                ...
                                                                viewBox="0 0 24 24" class="source-logo2">
                                                                <path
                                                                    d="M17.4541016,11H6.5458984c-0.276123,0-0.5,0.223877-0.5,0.5s0.223877,0.5,0.5,0.5h10.9082031c0.276123,0,0.5-0.223877,0.5-0.5S17.7302246,11,17.4541016,11z M19.5,2h-15C3.119812,2.0012817,2.0012817,3.119812,2,4.5v11c0.0012817,1.380188,1.119812,2.4987183,2.5,2.5h12.7930298l3.8534546,3.8535156C21.2402344,21.9473267,21.3673706,22,21.5,22c0.276123,0,0.5-0.223877,0.5-0.5v-17C21.9987183,3.119812,20.880188,2.0012817,19.5,2z M21,20.2929688l-3.1464844-3.1464844C17.7597656,17.0526733,17.6326294,17,17.5,17h-13c-0.828064-0.0009155-1.4990845-0.671936-1.5-1.5v-11C3.0009155,3.671936,3.671936,3.0009155,4.5,3h15c0.828064,0.0009155,1.4990845,0.671936,1.5,1.5V20.2929688z M17.4541016,8H6.5458984c-0.276123,0-0.5,0.223877-0.5,0.5s0.223877,0.5,0.5,0.5h10.9082031c0.276123,0,0.5-0.223877,0.5-0.5S17.7302246,8,17.4541016,8z">
                                                                </path>
                                                            </svg>
                                                    ...
                                                    <div
                                                        class=" d-flex flex-fill align-items-center justify-content-between">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-0">
                                                            ...
                                                            <p
                                                                class="text-muted fw-normal fs-12 header-notification-text mb-0">
                                                                2 hours ago
                                                            </p>
                                                        </div>
                                                        <div>
